...
class JConfig
{
	...
	public $sitename = 'Sea Side Park Hotel';            // Name of Joomla site
	...
	public $password = 'f33de6d5de';                   // DB password
	public $db = 'bitnami_joomla';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'd8f078c20b50b6fd55324e9027d5528d';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = 'C:/xampp/apps/joomla/tmp';                // This path needs to be writable by Joomla!
	public $log_path = 'C:/xampp/apps/joomla/logs'; // This path needs to be writable by Joomla!
